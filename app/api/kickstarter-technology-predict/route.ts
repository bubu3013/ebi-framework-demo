...
import { predictWithOpenAI, predictWithClaude } from "@/lib/kickstarter-technology-llm"
import type { KickstarterFeatures } from "@/lib/kickstarter-technology-llm"
...
export async function POST(req: Request) {
  try {
    ...
    const row = features[0] as KickstarterFeatures
    let raw: string
